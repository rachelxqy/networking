...
public class IG {
	...
	public static void main(String args[]) throws Exception
	{
		try {
			...
			byte[] DataFromC = new byte[byteleng]; // data from client
			byte[] DataToS = new byte[byteleng];       // data to server
			byte[] DataFromS = new byte[byteleng]; // data from server
			byte[] DataToC = new byte[byteleng];       // data to client
